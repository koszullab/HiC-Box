...
class level():
    ...
    def load_data(self, pyramid):
        ...
        self.pos_vect_frags_4_GL = np.ndarray(shape=(int(self.n_frags), 4), dtype=np.float32)
        self.col_vect_frags_4_GL = np.ndarray(shape=(int(self.n_frags), 4), dtype=np.float32)
